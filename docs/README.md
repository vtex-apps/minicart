...
| `showTotalItemsQty`    | `enum`                    | Shows the quantity badge as total items in cart counting their quantities or display just distinct items ignoring their quantities. Possible values are: `total` or `distinct`. | `distinct` |
